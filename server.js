...
// ─────────────────────────────────────────────
// All FREE Cloudflare models — rotates to avoid 429 rate limits
const CF_MODELS = [
  ...
  { id: '@cf/runwayml/stable-diffusion-v1-5',              body: p => ({ prompt: p }) },
  ...
  { id: '@cf/lykon/absolute-reality-v1-8-1',               body: p => ({ prompt: p }) },
  { id: '@cf/prompthero/openjourney',                      body: p => ({ prompt: p }) },
  { id: '@cf/wavymulder/analog-diffusion',                 body: p => ({ prompt: p }) },
];
let cfModelIndex = 0;
